<x-templates.default>
    ...
    <form
        ...
        <div class="card-header">
            <h1 class="card-title">Perbarui Ulasan Anda untuk {{ $review->place->name }}</h1>
        </div>
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <select
                    ...
                    <option value="{{ $data->id }}" @if ($data->id == $review->place_id) selected
            ...
            <div class="form-group mt-3">
                ...
                <textarea
                    ...
                    name="reviews"
                    rows="6"
                    placeholder="Content">{{ $review->reviews ?? old('reviews') }}</textarea>
            ...
            <div class="form-group mt-3">
                ...
                <label class="form-check form-check-inline">
                    <input
                        ...
                        name="rating"
                        type="checkbox"
                        value="{{ $item }}" @if ($item == $review->rating)
                           checked
                        @endif>
